return {
  {
    ...
    config = function(_, opts)
      ...
      dap.adapters.coreclr = {
        ...
        -- command = "C:/Users/richard/AppData/Local/nvim-data/mason/packages/netcoredbg/netcoredbg",
      ...
      dap.adapters.codelldb = {
        ...
        port = "${port}",
        executable = {
          command = "C:/Users/richard/AppData/Local/nvim-data/mason/packages/codelldb/extension/adapter/codelldb",
          args = { "--port", "${port}" },
      ...
      dap.configurations.rust = {
        {
          ...
          request = "launch",
          program = function()
            return vim.fn.input("Path to exe/dll: ", vim.fn.getcwd() .. "/", "file")
          end,
          cwd = "${workspaceFolder}",
          stopOnEntry = false,
        },
